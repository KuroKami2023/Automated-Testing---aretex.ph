...
describe('Home', () => {
  ...
  it('should go to contact us and pass valid details', () => {
  ...
  it('should go to another contact us and pass valid details', () => {
